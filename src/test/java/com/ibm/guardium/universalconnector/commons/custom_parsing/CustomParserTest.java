...
public class CustomParserTest {
    ...
    public void testParseRecordValidPayload() {
        ...
        assertEquals(Integer.parseInt(configValues.get(PropertyConstant.CLIENT_PORT)), record.getSessionLocator().getClientPort());
        assertEquals(Integer.parseInt(configValues.get(PropertyConstant.SERVER_PORT)), record.getSessionLocator().getServerPort());
    ...
    public void testConvertToInt() {
        assertEquals(Integer.valueOf(53422), customParser.convertToInt(PropertyConstant.CLIENT_PORT, configValues.get(PropertyConstant.CLIENT_PORT)));
        assertNull(customParser.convertToInt(PropertyConstant.CLIENT_PORT, "invalid"));
    }

    @Test
    public void testGetValue() {
        String value = customParser.getValue(String.format("[Session ID: %s]", configValues.get(PropertyConstant.SESSION_ID)), PropertyConstant.SESSION_ID);
    ...
    public void testParseRecordWithSnifferPayload() throws IOException {
        ...
        assertEquals(Integer.parseInt(snifferConfigValues.get("client_port")), record.getSessionLocator().getClientPort());
        assertEquals(Integer.parseInt(snifferConfigValues.get("server_port")), record.getSessionLocator().getServerPort());
    ...
    public void testParseRecordWithRegexPayload() throws IOException {
        ...
        assertEquals(Integer.parseInt(regexConfigValues.get("client_port")), record.getSessionLocator().getClientPort());
        assertEquals(Integer.parseInt(regexConfigValues.get("server_port")), record.getSessionLocator().getServerPort());
    ...
    public void testIsValid() {
        ...
        assertTrue("Expected isValid to return true when SQL parsing is inactive", customParser.isValid("some payload"));
    ...
    public void testGetServerTypeAndIsSnifferParsing() {
        ...
        assertEquals("Parsing type can only be REGEX or SNIFFER", SqlParser.ValidityCase.INVALID_PARSING_TYPE.getDescription());
